...
uint16_t Localbus_ReadData(uint32_t addr) {
  ...
  while (!Localbus_ARM_WAIT);
	...
	data_t[8] = (GPIOE->IDR & GPIO_Pin_8);
	data_t[9] = (GPIOE->IDR & GPIO_Pin_9);
	data_t[10] = (GPIOE->IDR & GPIO_Pin_10);
	data_t[11] = (GPIOE->IDR & GPIO_Pin_11);
	data_t[12] = (GPIOE->IDR & GPIO_Pin_12);
	data_t[13] = (GPIOE->IDR & GPIO_Pin_13);
	data_t[14] = (GPIOE->IDR & GPIO_Pin_14);
	data_t[15] = (GPIOE->IDR & GPIO_Pin_15);
